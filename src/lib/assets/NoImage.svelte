    ...
    function defaultAnimate() {
        ...
        el.animate(
            [
                ...
                { transform: "rotate(25deg)" } // or whatever subtle movement you want
            ],
            {
                duration: 300,
                easing: "ease-out",
